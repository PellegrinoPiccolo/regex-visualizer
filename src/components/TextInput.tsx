...
const TextInput = ({ value, onChange } : { value: string, onChange: (e: React.ChangeEvent<HTMLTextAreaElement>) => void }) => {
  return (
    <div className="w-full h-64 p-4 text-sm rounded-xl border border-slate-800/80 bg-slate-950/60 shadow-lg shadow-slate-950/40 focus-within:ring-2 focus-within:ring-cyan-400/60">
        <textarea
